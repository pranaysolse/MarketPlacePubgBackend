...
app.post('/login',async (req,res)=>{
    ...
    // await redis_client.set(refreshToken,username,redis.print)
    // console.log(await redis_client.get(refreshToken,redis.print))
...
app.delete('/logout',(req,res)=>{
    ...
    jwt.verify(refresh_token,process.env.REFRESH_TOKEN,(error,user)=>{
        ...
        // redis_client.del(refresh_token,redis.print)
        refreshTokenArray = refreshTokenArray.filter((token)=>{
